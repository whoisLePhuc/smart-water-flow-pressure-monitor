...
- Implementation status: **IMPLEMENTED FOUNDATION / PARTIAL COVERAGE**
- Đã có trong code: ADC/storage ports, Linux providers/peers and platform runtime abstractions exist.
- Chưa hoàn tất: Port coverage and injection are incomplete; storage service still depends on FramDriver and most STM32 peripherals lack adapters.
