...
27. Pressure variant, ZSSC3241 profile và per-device calibration phải tương thích theo versioned manifest; mismatch không được tạo accepted production pressure.
